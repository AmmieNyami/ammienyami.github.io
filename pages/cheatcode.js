class Sha256 {
    ...
    static hash(msg, options) {
        ...
        function hexBytesToString(hexStr) {
            ...
            return str=='' ? '' : str.match(/.{2}/g).map(byte =>
...
function PAGES_CHEATCODE_validateInput() {
    const cheatcode = document.getElementById("cheatcode");
    if (Sha256.hash(cheatcode.value, {})
        === "db54a61161039501f69855246619089c6a68be19a1842bb4d3ac95322c7b486b") {
        alert("Congrats! You found a useless cheat code");
    } else {
